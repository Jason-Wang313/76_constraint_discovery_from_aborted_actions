...
Honest strongest claim: `Use aborted or interrupted actions as evidence for hidden constraints.` is a plausible branch-structured mechanism for robot planning and safety, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
